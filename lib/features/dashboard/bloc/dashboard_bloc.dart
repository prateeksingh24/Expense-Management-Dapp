...
class DashboardBloc extends Bloc<DashboardEvent, DashboardState> {
  ...
  FutureOr<void> dashboardInitialFechEvent(
    ...
    try {
      ...
      String privateKey =
          "0xd8bb1b1c5b617b74f56d2d855d4b1d9b5102383540c107af9129082d5a6de7b4";
      ...
      _contractAddress =
          EthereumAddress.fromHex("0xaf14cC1837280aDC4479Da92e9681BfF96400459");
    ...
    try {
      final transaction = Transaction.callContract(
          from: EthereumAddress.fromHex(
              "0xaf14cC1837280aDC4479Da92e9681BfF96400459"),
          contract: _deployedContract,
          function: _deposit,
          parameters: [
